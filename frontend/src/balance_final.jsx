...
function SimulationPage() {
    ...
    const handleRunSimulation = async () => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:8080/api/v1/simulations/run-test', {
    ...
    const handleGetBalance = async () => {
        ...
        clearResults();
        try {
            const response = await axios.get('http://localhost:8080/api/v1/simulations/balance-feedback');
