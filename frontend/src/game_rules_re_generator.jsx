          ...
          <form onSubmit={handleRegenerateRule} className="regenerate-rule-form">
            <div className="form-group">
              ...
              <input
                type="number"
                id="regenerateRuleId"
                value={regenerateRuleId}
                onChange={(e) => setRegenerateRuleId(e.target.value)}
                placeholder="예: 23, 2222"
                required
              />
            </div>
            <div className="form-group">
              ...
              <textarea
                id="regenerateRuleFeedback"
                value={regenerateRuleFeedback}
                onChange={(e) => setRegenerateRuleFeedback(e.target.value)}
                placeholder="예: 행동이 너무 단순한 것 같아요. 좀 더 다양한 전략이 있었으면 해요."
                rows="3"
                required
              ></textarea>
            </div>
